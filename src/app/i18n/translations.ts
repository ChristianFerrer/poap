...
const es = {
  ...
  explorer: {
    ...
    categoryRequired: "Elegí a qué track del plan del proyecto pertenece — es obligatorio.",
...
const en: Translations = {
  ...
  explorer: {
    ...
    categoryRequired: "Choose which project-plan track this belongs to — required.",
